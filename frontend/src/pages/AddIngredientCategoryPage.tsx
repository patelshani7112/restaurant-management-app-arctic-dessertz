// frontend/src/pages/AddIngredientCategoryPage.tsx
import React, { useState } from "react";
import { useNavigate } from "react-router-dom";
import apiClient from "../services/apiClient.ts";

const AddIngredientCategoryPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError(null);
    try {
      await apiClient.post("/ingredient-categories", { name });
...
export default AddIngredientCategoryPage;
